            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form @submit.prevent="submit" class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-3 gap-10 mb-4 items-start">
                            <!-- Civil Status -->
                            <div class="w-full">
                                <label
                                    for="civil_status"
                                    class="text-gray-700 dark:text-surface-0 text-sm font-medium mb-2 block"
                                    >Civil Status<span class="ml-1 text-red-400"
                                        >*</span
                                    ></label
                                >
                                <FormField
                        ...
                        <div class="grid grid-cols-2 gap-10 mb-4">
                            ...
                            <div class="w-full">
                                <label
                                    for="contact_number"
                                    class="text-gray-700 dark:text-surface-0 text-sm font-medium mb-2 block"
                                    >Contact no.<span class="ml-1 text-red-400"
                                        >*</span
                                    >
                                </label>
                                <FormField
                            ...
                            <div class="w-full">
                                <label
                                    ...
                                    >Contact no.<span
                                        ...
                                        >(of Person Incase of Emergency)</span
                            ...
                            <div class="w-full">
                                ...
                                >
                                    ...
                                    <Message
                                        ...
                                        size="small"
                                        variant="simple"
                                        >{{ form.errors.pagibig_no }}</Message
                                    >
                                </FormField>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        >
                        <div class="grid grid-cols-2 gap-10 mb-4 items-center">
                            <!-- License no.-->
                            <div class="w-full">
                                <label
                                    for="address"
                                    class="text-gray-700 dark:text-surface-0 text-sm font-medium mb-2 block"
                                    >License no.<span class="ml-1 text-red-400"
                                        >*</span
                                    ></label
                                >
                                <FormField
